...
public class FindBridgeTest {
        ...
        * */
        ...
        public void BidGate2()  throws IOException{
            ...
            String Node;
            File file = new File("src/Algorithmpcg/TestFB/input1.in");
            ...
            file = new File("src/Algorithmpcg/TestFB/output1.out");
            In = new Scanner(file);
        ...
        String Node;
        File file = new File("src/Algorithmpcg/TestFB/input2.in");
        Scanner In = new Scanner(file);
        ...
        file = new File("src/Algorithmpcg/TestFB/output2.out");
        In = new Scanner(file);
        countOfEdges=In.nextInt();
        Node = In.nextLine();
        for(int i = 0; i < countOfEdges; i++)
